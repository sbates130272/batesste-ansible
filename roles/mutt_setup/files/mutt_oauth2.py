...
ENCRYPTION_PIPE = ['gpg', '--encrypt', '--recipient', 'sbates@raithlin.com']
...
registrations = {
    'google': {
        ...
        'client_id': '820776054822-0t1h7vrls0rgp8e3ckp73hi6395dvoam.apps.googleusercontent.com',
    ...
    'microsoft': {
        ...
        'client_id': 'b02362e2-25dd-406b-b103-03752acb2740',
        'client_secret': '',
    },
}
