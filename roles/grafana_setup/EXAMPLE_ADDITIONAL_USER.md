...
Edit `../../inventory/inventories/hosts-grafana-setup.yml` (relative to the role directory):
...
```bash
ansible-playbook -i ../../inventory/inventories/hosts-grafana-setup.yml ./tests/test.yml --ask-vault-pass
```
